									...
									<div class="tab_BG_h">
										<div class="tab_R_h" style="padding-right: 40px;">
											<div class="tab_L_h" style="padding: 3px 11px 0px 6px; text-align: left;">
												...
												<a href="javascript:leftnavExpand('CRF_infobox_closed'); leftnavExpand('CRF_infobox_open');">
													<img src="<c:out value="${contextPath}" />/images/sidebar_collapse.gif"
																...
																<a href="#"
																   ...
																   onClick="openDNoteWindow('ViewDiscrepancyNote?writeToDB=1&subjectId=${studySubject.id}&itemId=${itemId}&id=${InterviewerNameNote.eventCRFId}&name=${InterviewerNameNote.entityType}&field=interviewer&column=${InterviewerNameNote.column}&enterData=${enterData}&monitor=${monitor}&blank=${blank}','spanAlert-interviewDate'); return false;">
																	...
																	<a id="nameNote1"
																	   ...
																	   onmouseout="UnTip();"
																	   onmouseover="callTip(genToolTipFromArray('interviewNotes'));"
																	   onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${studySubject.id}&viewData=y&id=
																		   <c:out value="${toc.eventCRF.id}"/>&name=eventCrf&field=interviewer&column=interviewer_name&writeToDB=1&new=${isNewDN}','spanAlert-interviewer'); return false;">
																		<img id="flag_interviewer"
																		     name="flag_interviewer"
